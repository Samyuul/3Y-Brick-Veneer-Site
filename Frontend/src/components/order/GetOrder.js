...
const GetOrder = (props) => {
    ...
    return (
        ...
        <div id="gallery">
            ...
            <h1>Gallery</h1>
            <p>
                If the current stock has not loaded yet, please give it a minute. In the meanwhile, you
                can browse our gallery below. The value are units of boxes (10.75 sqft each).
            </p>
